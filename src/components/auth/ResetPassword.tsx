...
function ResetPassword() {
    const [resetDetails, setResetDetails] = useState({new_password:"",confirm_new_password:"",reset_password_token:""});
      ...
      <form className="w-full" onSubmit={handleSubmit}>
        <div className="flex flex-col space-y-1 w-full">
          ...
          <Input
            ...
            onChange={(e) =>
              setResetDetails({ ...resetDetails, new_password: e.target.value })
            }
          />
          {errors?.new_password && (
        ...
        <div className="flex flex-col space-y-1 w-full">
          ...
          <Input
            ...
            placeholder="New Password"
            onChange={(e) =>
              setResetDetails({ ...resetDetails, confirm_new_password: e.target.value })
            }
          />
          {errors?.new_password && (
            <p style={{ color: "red" }}>{errors?.email[0]}</p>
